...
ctx.color("grey");
ctx.linewidth (1);
ctx.rectangle(x =150, y=143, width  = 430, height= 200);
ctx.stroke();
...
ctx.color("blue");
ctx.linewidth(5);
ctx.circle(x= 250, y= 210, r=40, startAngle=0, endAngle=2);
ctx.stroke();
...
ctx.color("black");
ctx.linewidth(5);
ctx.circle(x= 350, y= 210, r=40, startAngle=0, endAngle=2);
ctx.stroke();
// Similarly, create a red circle with position 210 and 40
ctx.beginPath();
ctx.color("red");
ctx.linewidth(5);
ctx.circle(x= 210, y= 40, r=40, startAngle=0, endAngle=2);
ctx.stroke();
// Similarly, create an orange circle with position 300 and 250
ctx.beginPath();
ctx.color("orange");
ctx.linewidth(5);
ctx.circle(x= 300, y= 250, r=40, startAngle=0, endAngle=2);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250ctx.beginPath();
ctx.beginPath()
ctx.color("green");
ctx.linewidth(5);
ctx.circle(x= 400, y= 250, r=40, startAngle=0, endAngle=2);
ctx.stroke();